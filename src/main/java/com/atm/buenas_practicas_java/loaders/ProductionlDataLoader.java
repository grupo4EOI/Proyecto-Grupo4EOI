...
public class ProductionlDataLoader {
    ...
    public void loadDataProduccion() {
        ...
        persona1.setBiografia("Este chaval nació en Torremolinos junto con su familia y amigos." +
                ...
                "haber protagonizado la saga cinematográfica de Harry Potter. Fundamentalmente por " +
                "ello, ha recaudado una fortuna de 23 millones de libras esterlinas, parte de la cual ha" +
                " destinado a organizaciones benéficas.");
        ...
        persona2.setBiografia("Esta chavala nació en Guadalajara junto con su familia y amigos." +
                ...
                "conocida principalmente por haber interpretado el personaje de Hermione Granger " +
